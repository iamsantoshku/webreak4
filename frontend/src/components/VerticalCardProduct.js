...
//                 {loading ? (
//                     loadingList.map((_, index) => (
//                         <div key={index} className='w-full min-w-[150px] md:min-w-[200px] max-w-[150px] md:max-w-[200px] bg-white rounded-sm shadow'>
...
//                 ) : (
//                     data.map((product, index) => (
//                         <div key={index} className='w-full min-w-[150px] md:min-w-[200px] max-w-[150px] md:max-w-[200px] bg-white rounded-sm shadow relative'>
//                             <Link to={`/product/${product?._id}`} className='block'>
//                                 <ImageHoverSlider images={product.productImage} productName={product?.productName} />
//                             </Link>
...
//     return (
//         <div
//             className='bg-slate-200 h-60 md:h-72 p-4 min-w-[150px] md:min-w-[200px] flex justify-center items-center'
//             onMouseEnter={startImageRotation}
//             onMouseLeave={stopImageRotation}
//         >
//             <img
