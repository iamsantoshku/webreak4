...
//   return (
//     <header className='h-11 lg:h-20 ls:h-16 shadow-md bg-white fixed w-full z-40'>
...
//                 <GrSearch className="text-xl" /> {/* Adjust icon size for mobile */}
//               </button>
//             </div>
//           ) : (
...
// <div className='relative flex justify-center ml-3' ref={menuRef}>
//             {user?._id && (
//               <div
...
//                 ) : (
//                   <FaRegCircleUser className="text-xl mt-2" /> 
//                   // adjust 
//                 )},
//               </div>
//             )}
...
const Header = () => {
  ...
  return (
    <header className='h-16 sm:h-20 md:h-24 lg:h-20 xl:h-20 shadow-md bg-white fixed w-full z-40'>
      <div className='h-full container mx-auto flex items-center px-4 justify-between'>
