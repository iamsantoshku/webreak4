...
//             <div className='grid grid-cols-2 gap-4 md:grid-cols-[repeat(auto-fit,minmax(250px,270px))] md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
//                 {loading ? (
//                     loadingList.map((_, index) => (
//                         <div key={index} className='w-full bg-white rounded-sm shadow'>
//                             <div className='bg-slate-200 h-60 flex justify-center items-center animate-pulse'>
//                             </div>
//                             <div className='p-4 grid gap-3'>
//                                 <h2 className='font-medium text-base text-ellipsis line-clamp-1 text-black p-1 py-2 animate-pulse rounded-full bg-slate-200'></h2>
//                                 <p className='capitalize text-slate-500 p-1 animate-pulse rounded-full bg-slate-200 py-2'></p>
...
//                     data.map((product) => (
//                         <Link key={product?._id} to={"/product/" + product?._id} className='w-full bg-white rounded-sm shadow' onClick={scrollTop}>
//                             <div className='bg-slate-200 h-72 flex justify-center items-center'>
...
const CategroyWiseProductDisplay = ({ category, heading }) => {
    ...
    return (
        <div className='container mx-auto px-4 my-6 relative'>
            ...
            <div className='grid grid-cols-2 gap-4 md:grid-cols-[repeat(auto-fit,minmax(230px,250px))] md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
                {loading ? (
                    loadingList.map((_, index) => (
                        <div key={index} className='w-full bg-white rounded-sm shadow'>
                            <div className='bg-slate-200 h-60 flex justify-center items-center animate-pulse'>
